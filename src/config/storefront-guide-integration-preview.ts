import type { WordPressContentSource } from "@/types/view-models/content";

export const guideIntegrationFixtures: readonly WordPressContentSource[] = [
  {
    id: 701,
    kind: "guide",
  ...
  },
  {
    ...
    modifiedAt: "2026-07-11T08:00:00+07:00",
    categoryIds: ["device"],
  ...
  },
  {
    ...
    contentFamilyCode: "device-esim-check",
    locale: "en",
    slug: "how-to-check-esim-support",
    titleHtml: "How to check whether your phone supports eSIM",
    excerptHtml: "<p>Check compatibility before buying an eSIM plan.</p>",
    contentHtml: [
    ...
    featuredImageUrl: "/assets/storefront/content/device-check.svg",
    featuredImageAlt: "Check whether a phone supports eSIM",
    publishedAt: "2026-07-02T08:00:00+07:00",
    categoryIds: ["device"],
    categoryLabels: ["Device compatibility"],
    seo: {
      title: "How to check eSIM support | YSim",
      description: "Check whether your phone supports eSIM before purchasing.",
      noindex: false,
    },
  },
];
