...
import { guideCategories, guideLandingHero } from "@/config/storefront-content";

const contentFixtures: readonly WordPressContentSource[] = [
  {
    id: 601,

    kind: "guide",

    contentFamilyCode: "esim-install-before-arrival",

    locale: "vi",

    slug: "nen-cai-esim-truoc-hay-sau-khi-den-noi",

    titleHtml: "Nên cài eSIM trước hay sau khi đến nơi?",
    ...
    featuredImageUrl: "/assets/storefront/content/install-esim.svg",

    featuredImageAlt: "Hướng dẫn cài đặt eSIM trước chuyến đi",

    publishedAt: "2026-07-01T08:00:00+07:00",

    modifiedAt: "2026-07-10T08:00:00+07:00",

    categoryIds: ["installation"],

    categoryLabels: ["Cài đặt eSIM"],

    seo: {
      title: "Nên cài eSIM trước hay sau khi đến nơi? | YSim",
  ...
  },
  {
    ...
    contentFamilyCode: "device-esim-check",

    locale: "vi",

    slug: "cach-kiem-tra-dien-thoai-ho-tro-esim",

    titleHtml: "Cách kiểm tra điện thoại có hỗ trợ eSIM",
    ...
    featuredImageUrl: "/assets/storefront/content/device-check.svg",

    featuredImageAlt: "Kiểm tra điện thoại hỗ trợ eSIM",

    publishedAt: "2026-07-02T08:00:00+07:00",

    categoryIds: ["device"],

    categoryLabels: ["Kiểm tra thiết bị"],
  },
  {
    id: 603,
    ...
    contentFamilyCode: "esim-vs-roaming",

    locale: "vi",

    slug: "esim-khac-roaming-quoc-te-nhu-the-nao",

    titleHtml: "eSIM khác roaming quốc tế như thế nào?",
    ...
    featuredImageUrl: "/assets/storefront/content/roaming.svg",

    featuredImageAlt: "So sánh eSIM và roaming quốc tế",

    publishedAt: "2026-07-03T08:00:00+07:00",

    categoryIds: ["usage"],

    categoryLabels: ["Cách sử dụng"],
  },
];

export const contentPreviewArticles = contentFixtures.map(
  createArticleCardViewModel,
);

export const contentPreviewLanding: ContentLandingViewModel = {
...
export const contentPreviewArticle = createArticlePageViewModel(
  contentFixtures[0],
);

export const contentPreviewArticlePage = {
  article: contentPreviewArticle,

  relatedTitle: "Tiếp tục tìm hiểu về eSIM",

  relatedArticles: contentPreviewArticles.slice(1),

  callout: {
    title: "Ghi nhớ trước khi cài đặt",
