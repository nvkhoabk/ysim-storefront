...
export const contentLocaleFallbacks: Readonly<
  Record<ContentLocale, readonly ContentLocale[]>
> = {
  vi: ["vi"],
  en: ["en", "vi"],
  lo: ["lo", "en", "vi"],
...
export const guideLandingHero: HeroViewModel = {
...
export const guideCategories: readonly ContentCategoryViewModel[] = [
  {
    id: "all",
    label: "Tất cả",
    href: "/guides",
