export type FooterSocialIcon = "facebook" | "instagram" | "youtube" | "message";

export type TrustFeatureIcon = "instant" | "global" | "secure" | "support";
...
export const storefrontFooter: StorefrontFooterConfig = {
  brand: {
    description:
  ...
  trustFeatures: [
    {
      ...
      description: "Nhận eSIM ngay sau khi thanh toán.",
      icon: "instant",
    },
    {
    ...
    },
    {
      ...
      description: "Thanh toán và dữ liệu được bảo vệ.",
      icon: "secure",
    },
    {
      title: "Hỗ trợ 24/7",
      description: "Đồng hành cùng bạn trong suốt chuyến đi.",
      icon: "support",
    },
  ],
