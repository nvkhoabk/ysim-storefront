...
export const storefrontNavigation: StorefrontNavigationConfig = {
  announcement: {
    enabled: true,
    message:
    ...
    actionHref: "/support",
    storageKey: "ysim:announcement:navigation-v1",
  },
          ...
          links: [
            {
              ...
              description: "Các gói eSIM Nhật Bản",
            },
            {
              label: "Hàn Quốc",
              href: "/destinations/south-korea",
              description: "Các gói eSIM Hàn Quốc",
            },
            {
              label: "Thái Lan",
              href: "/destinations/thailand",
              description: "Các gói eSIM Thái Lan",
            },
            {
              label: "Singapore",
              href: "/destinations/singapore",
              description: "Các gói eSIM Singapore",
            },
          ],
        },
        {
      ...
      groups: [
        {
          ...
          links: [
            ...
            },
            {
              ...
              href: "/guides/cach-kiem-tra-dien-thoai-ho-tro-esim",
            },
          ],
        },
        {
          ...
          links: [
            {
              label: "eSIM và roaming",
              href: "/guides/esim-khac-roaming-quoc-te-nhu-the-nao",
            },
            {
