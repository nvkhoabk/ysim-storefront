...
import type { DeviceManualCheckViewModel } from "@/types/view-models/support";
...
export interface DeviceCheckGuideProps {
  steps: readonly DeviceManualCheckViewModel[];
}

export function DeviceCheckGuide({ steps }: DeviceCheckGuideProps) {
