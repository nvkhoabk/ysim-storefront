...
const contactItems = [
  {
    label: "Tầng 5, Tòa nhà Ladeco, 266 Đội Cấn, Ba Đình, Hà Nội, Việt Nam",
  ...
  return (
    <div>
      ...
      <p className="mt-5 max-w-[330px] text-[13px] leading-6 text-slate-600">
        YSim là nền tảng eSIM toàn cầu giúp bạn kết nối Internet nhanh chóng, ổn
        định và tiện lợi tại hơn 200 quốc gia và vùng lãnh thổ.
      </p>
        ...
        {contactItems.map((item) => {
          ...
          return (
            <a
              ...
              className="group flex max-w-[350px] items-start gap-3 text-[13px] leading-5 text-slate-700 transition hover:text-green-700"
            >
              <Icon
                aria-hidden="true"
                className="mt-0.5 h-[18px] w-[18px] shrink-0 text-green-700"
                strokeWidth={1.8}
              />
