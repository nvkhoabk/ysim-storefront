  ...
  return (
    <div className="hidden overflow-hidden rounded-[var(--ysim-radius-xl)] border border-[var(--ysim-color-border)] bg-white lg:block">
      <table className="w-full border-collapse">
        <thead className="bg-[var(--ysim-color-surface-subtle)] text-left text-xs font-bold tracking-[0.08em] text-[var(--ysim-color-text-muted)] uppercase">
          <tr>
            <th className="px-5 py-4">{t("ordinary.tableDestination")}</th>
            <th className="px-5 py-4">{t("ordinary.tableRegion")}</th>
            <th className="px-5 py-4">{t("ordinary.tableDuration")}</th>
            <th className="px-5 py-4">{t("ordinary.tablePlans")}</th>
            <th className="px-5 py-4">{t("ordinary.priceFrom")}</th>
            <th className="px-5 py-4 text-right">
              {t("ordinary.tableAction")}
            </th>
          </tr>
        </thead>
        ...
        <tbody>
          {items.map((item) => (
            ...
            >
              ...
              <td className="px-5 py-4">
                <Price amount={item.priceFrom} size="compact" />
              </td>
