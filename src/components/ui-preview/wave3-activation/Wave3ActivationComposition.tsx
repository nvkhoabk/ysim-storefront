...
import {
  Wave3ActivationRouteCard,
} from "./Wave3ActivationRouteCard";

export function Wave3ActivationComposition({
  plan,
}: {
  plan:
    Wave3ActivationPlanViewModel;
      ...
      <Section>
        <Container>
          <SectionHeader
            ...
            title="Cart → Checkout → Order → Payment"
            description="Mỗi route có source switch, feature flag và rollback độc lập."
          />
