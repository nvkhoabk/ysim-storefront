...
import { TrustFeatureRow } from "./TrustFeatureRow";
...
function isExternalHref(link: FooterLink): boolean {
...
function FooterNavLink({ link }: { link: FooterLink }) {
  const content = (
    <>
      ...
      {link.badge ? (
        <span className="rounded-[var(--ysim-radius-pill)] bg-white/10 px-2 py-0.5 text-[10px] font-bold tracking-wide text-white/80 uppercase">
          {link.badge}
        </span>
      ) : null}
      {isExternalHref(link) ? (
                  ...
                  {config.appLinks.map((app) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span>
                          <span className="block text-[10px] tracking-wide text-white/55 uppercase">
                            {app.comingSoon
                              ? labels.comingSoon
                              : labels.download}
                          </span>
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <section aria-labelledby="footer-payment-title">
                <h2
                  ...
                  className="text-xs font-bold tracking-[0.12em] text-white/55 uppercase"
                >
                  {labels.paymentTitle}
                </h2>
