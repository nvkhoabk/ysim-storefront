...
export function GlobalLoadingState({
  ...
  const copy = globalStateMessages(useStorefrontLocale().locale);
  const resolvedTitle = title ?? copy.loadingTitle;
  const resolvedDescription = description ?? copy.loadingDescription;
