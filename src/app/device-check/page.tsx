...
export const metadata = {
  ...
  description: "Kiểm tra điện thoại của bạn có hỗ trợ eSIM trước khi mua.",
};
      ...
      <main className="min-h-[65vh] bg-slate-50 px-5 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-lg text-center leading-7 text-slate-600">
            Nhập tên hoặc model điện thoại để kiểm tra thiết bị có hỗ trợ eSIM
            hay không.
          </p>
          ...
          <div className="relative mt-7">
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-slate-300 bg-white pr-4 pl-12 text-sm transition outline-none focus:border-green-600 focus:ring-2 focus:ring-green-100"
            />
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600">
                  Danh sách thiết bị hỗ trợ eSIM sẽ được bổ sung trong bước tiếp
                  theo.
                </p>
              </div>
            </div>
          ...
          <Link
            href="/"
            className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-green-700 hover:text-green-800"
          >
